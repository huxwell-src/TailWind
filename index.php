      ...
      <div class="container flex flex-col-reverse lg:flex-row items-center gap-12 mt-14 lg:mt-28">
        ...
        <div class="flex flex-1 flex-col items-center lg:items-start">
          ...
          <div class="flex justify-center flex-wrap gap-6">
		  	<button type="button" class="bg-bookmark-purple text-white rounded-md px-7 py-3  hover:bg-bookmark-white hover:text-black">Get it on Chrome</button>
        ...
        <div class="flex justify-center flex-1 mb-10 md:mb-16 lg:mb-0 z-10">
          <img class="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full" src="<?php home_url();?>/wp-content/uploads/2022/06/hero-bg.png" alt="" />
        </div>
      </div>
      <!-- Rounded Rectangle -->
      <div
        ...
        <div class="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
          ...
          <div class="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
            <img
              ...
              src="<?php home_url();?>/wp-content/uploads/2022/06/illustration-features-tab-1.png"
              alt=""
            />
          </div>
          <!-- Content -->
      ...
      <div class="relative mt-20 lg:mt-52">
        <div class="container flex flex-col lg:flex-row-reverse items-center justify-center gap-x-24">
          ...
          <div class="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
            <img
              class="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full"
              src="<?php home_url();?>/wp-content/uploads/2022/06/illustration-features-tab-2.png"
              alt=""
            />
          </div>
          <!-- Content -->
      ...
      <div class="relative mt-20 lg:mt-52">
        <div class="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
          ...
          <div class="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
            <img
              class="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full"
              src="<?php home_url();?>/wp-content/uploads/2022/06/illustration-features-tab-3.png"
              alt=""
            />
          </div>
          <!-- Content -->
      ...
      <div class="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 max-w-screen-lg mt-16">
        ...
        <div class="flex flex-col rounded-md shadow-md lg:mb-16">
          <div class="p-6 flex flex-col items-center">
            <img src="<?php home_url();?>/wp-content/uploads/2022/06/logo-chrome.svg" alt="" />
        ...
        <div class="flex flex-col rounded-md shadow-md lg:my-8">
          <div class="p-6 flex flex-col items-center">
		  	<img src="<?php home_url();?>/wp-content/uploads/2022/06/logo-firefox.svg" alt="" />
        ...
        <div class="flex flex-col rounded-md shadow-md lg:mt-16">
          <div class="p-6 flex flex-col items-center">
		 	<img src="<?php home_url();?>/wp-content/uploads/2022/06/logo-opera.svg" alt="" />
